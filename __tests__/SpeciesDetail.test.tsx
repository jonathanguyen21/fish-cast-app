...
describe('SpeciesDetail', () => {
  it('shows species common name', () => {
    const { getByText } = render(<SpeciesDetail speciesScore={makeScore()} />)
  ...
  it('shows score badge', () => {
    const { getByText } = render(<SpeciesDetail speciesScore={makeScore({ score: 75 })} />)
  ...
  it('shows current match labels', () => {
    const { getAllByText } = render(<SpeciesDetail speciesScore={makeScore()} />)
  ...
  it('shows best window summary when hourly data provided', () => {
    const { getByText } = render(<SpeciesDetail speciesScore={makeScore()} hourly={makeHourly()} />)
  ...
  it('hides best window when hourly is all zeros', () => {
    ...
    const { queryByText } = render(<SpeciesDetail speciesScore={makeScore()} hourly={zeros} />)
