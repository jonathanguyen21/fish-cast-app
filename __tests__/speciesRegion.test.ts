...
describe('getSpeciesForRegion', () => {
  it('freshwater spot type always returns freshwater species regardless of location', () => {
    ...
    expect(getSpeciesForRegion(42.4, -71.0, 'freshwater')).toBe(freshwaterSpecies)
  })
  ...
  it('saltwater spot on the Gulf returns southeast species', () => {
    expect(getSpeciesForRegion(29.3, -94.8, 'saltwater')).toBe(southeastSpecies)
  })

  it('saltwater spot in the northeast returns northeast species', () => {
    expect(getSpeciesForRegion(42.4, -71.0, 'saltwater')).toBe(northeastSpecies)
  })
